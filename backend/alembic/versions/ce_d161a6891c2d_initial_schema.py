...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            nullable=False,
            server_default="none",
            comment="向量化状态: none, outdated, pending, processing, completed, failed",
        ),
    ...
    op.create_index("ix_document_tags_gin", "document", ["tags"], postgresql_using="gin")
...
def downgrade() -> None:
    ...
    op.drop_index("ix_document_tags_gin", table_name="document")
