...
interface SiteSelectorProps {
  ...
  onSelect: (site: ClientSite | null) => void
}

export function SiteSelector({
  tenantSlug, selectedSite, isOpen, onToggle, containerRef,
  keyword, onKeywordChange, sites, searchLoading, onSelect,
}: SiteSelectorProps) {
    ...
    <div className="relative" ref={containerRef}>
      <button
        ...
        className={cn(
          ...
          "w-[140px] md:w-[200px]",
          isOpen && "bg-white border-primary/30 shadow-lg"
        )}
      >
          ...
          <div className="p-3 border-b border-slate-100 bg-slate-50/50">
            <div className="relative group">
              ...
              <Input
                ...
                placeholder={t("selector.placeholder", { tenantSlug })}
