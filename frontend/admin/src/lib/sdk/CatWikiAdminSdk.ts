...
import { AdminSystemInfoService } from './services/AdminSystemInfoService';
...
import { EeAdminSitesService } from './services/EeAdminSitesService';
...
export class CatWikiAdminSdk {
    ...
    public readonly adminSystemInfo: AdminSystemInfoService;
    ...
    public readonly eeAdminSites: EeAdminSitesService;
    ...
    constructor(config?: Partial<OpenAPIConfig>, HttpRequest: HttpRequestConstructor = FetchHttpRequest) {
        ...
        this.adminSystemInfo = new AdminSystemInfoService(this.request);
        ...
        this.eeAdminSites = new EeAdminSitesService(this.request);
